...
@R.register("models.CustomProtAlbert")
class CustomProtAlbert(nn.Module):
    def __init__(self, output_dim=4096):
        super().__init__()
        print("Initializing custom ProtAlbert")
        self.tokenizer = AlbertTokenizer.from_pretrained("Rostlab/prot_albert", cache_dir="/scratch/anna19/cache2/", use_fast=False, do_lower_case=False, do_basic_tokens=False)
        self.model = AutoModel.from_pretrained("Rostlab/prot_albert", cache_dir="/scratch/anna19/cache2/")
        self.model.eval()
    ...
    def forward(self, sequences, repr_layers=None, per_residue=False):
        ...
        encoded_input = self.tokenizer(
            ...
            max_length=552 #changed to 552 from 550 for ssp
        ).to(device)
